...
import channelChartData, {
  fetchChartData,
} from "layouts/dashboards/customer/components/TotalChart/data";
        ...
        <CardContent className="flex flex-1 flex-col gap-4 p-4">
          ...
          <div className="mt-auto flex flex-col gap-2 border-t border-border/30 pt-3 sm:flex-row sm:items-center sm:justify-between">
            <p className="text-xs text-muted-foreground leading-relaxed">
              Taleplerin <strong className="font-semibold text-foreground">açık / kapalı</strong> durumunu grafiksel olarak görebilirsiniz.
            </p>
            <Button
              type="button"
              variant="outline"
        ...
        <DialogContent className="max-w-sm">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2 text-base">
              ...
              {isAllData ? "Toplam" : "Açık"} Talep Sayısı
            </DialogTitle>
          </DialogHeader>
