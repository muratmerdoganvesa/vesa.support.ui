 ...
 */
export class DSInputComponent extends InputComponent {
  /**
  ...
  static get builderInfo() {
    return {
      ...
      documentation: '/userguide/#input',
      schema: DSInputComponent.schema()
    };
  }
}
...
//  */
DSInputComponent.editForm = (...args) => {
  const editForm = InputComponent.editForm(...args);
...
Formio.Components.addComponent('dsinput', DSInputComponent);
