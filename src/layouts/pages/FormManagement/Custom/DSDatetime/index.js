 ...
 */
export class DSDatetimeComponent extends DatetimeComponent {
  /**
  ...
  static get builderInfo() {
    return {
      ...
      schema: DSDatetimeComponent.schema()
    };
  }
}
...
//  */
DSDatetimeComponent.editForm = (...args) => {
  const editForm = DatetimeComponent.editForm(...args);
...
Formio.Components.addComponent('dsdatetime', DSDatetimeComponent);
