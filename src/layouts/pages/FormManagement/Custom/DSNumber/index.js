 ...
 */
export class DSNumberComponent extends NumberComponent {
  /**
  ...
  static get builderInfo() {
    return {
      ...
      schema: DSNumberComponent.schema()
    };
  }
}
...
//  */
DSNumberComponent.editForm = (...args) => {
  const editForm = NumberComponent.editForm(...args);
...
Formio.Components.addComponent('dsnumber', DSNumberComponent);
