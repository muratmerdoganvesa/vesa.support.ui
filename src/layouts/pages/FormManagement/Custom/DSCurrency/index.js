...
const CurrencyComponent = Formio.Components.components.currency;

/**
 * Create an Input component and extend from the InputComponent.
 */
export class DSCurrencyComponent extends CurrencyComponent {
  /**
  ...
  static get builderInfo() {
    return {
      ...
      schema: DSCurrencyComponent.schema()
    };
  }
}
...
//  */
DSCurrencyComponent.editForm = (...args) => {
  const editForm = CurrencyComponent.editForm(...args);
...
Formio.Components.addComponent('dscurrency', DSCurrencyComponent);
