 ...
 */
export class DSEmailComponent extends EmailComponent {
  /**
  ...
  static get builderInfo() {
    return {
      ...
      schema: DSEmailComponent.schema()
    };
  }
}
...
//  */
DSEmailComponent.editForm = (...args) => {
...
Formio.Components.addComponent('dsemail', DSEmailComponent);
