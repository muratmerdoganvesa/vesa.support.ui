...
const DayComponent = Formio.Components.components.day;

/**
 * Create an Input component and extend from the InputComponent.
 */
export class DSDayComponent extends DayComponent {
  /**
...
//  */
DSDayComponent.editForm = (...args) => {
  const editForm = DayComponent.editForm(...args);
...
Formio.Components.addComponent('dsday', DSDayComponent);
