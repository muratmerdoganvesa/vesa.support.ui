 ...
 */
export class DSSurveyComponent extends SurveyComponent {
  /**
  ...
  static get builderInfo() {
    return {
      ...
      schema: DSSurveyComponent.schema()
    };
  }
}
...
//  */
DSSurveyComponent.editForm = (...args) => {
  const editForm = SurveyComponent.editForm(...args);
...
Formio.Components.addComponent('dssurvey', DSSurveyComponent);
