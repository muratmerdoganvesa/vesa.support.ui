 ...
 */
export class DSCheckboxComponent extends CheckboxComponent {
  /**
  ...
  static get builderInfo() {
    return {
      ...
      schema: DSCheckboxComponent.schema()
    };
  }
}
...
//  */
DSCheckboxComponent.editForm = (...args) => {
  const editForm = CheckboxComponent.editForm(...args);
...
Formio.Components.addComponent('dscheckbox', DSCheckboxComponent);
